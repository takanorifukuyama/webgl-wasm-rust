...
type DispatchActions<Ks extends keyof any, T extends Record<Ks, any>> = ADT<
  "type",
  T
>;
...
const reducer = (state: CanvasState, action: Actions) => {
  switch (action.type) {
    case ACTION_TYPES[0]:
      return {
        ...state,
        width: parseInt(action.payload, 10),
        height: parseInt(action.payload, 10),
      };
    case ACTION_TYPES[1]:
    ...
    <div className="App">
      <div>
        ...
        <select
          ...
          onChange={(e) =>
            dispatch({ type: "DISK_SIZE_CHANGE", payload: e.target.value })
          }
        >
        ...
        <select
          value={state.diskNum}
          onChange={(e) =>
            dispatch({ type: "DISK_NUM_CHANGE", payload: e.target.value })
          }
        >
        ...
        <select
          value={state.height}
          onChange={(e) =>
            dispatch({ type: "WINDOW_CHANGE", payload: e.target.value })
          }
        >
